...
-- CreateIndex
CREATE INDEX "accounts_provider_user_id_idx" ON "accounts"("provider", "user_id");

-- CreateIndex
CREATE INDEX "invites_email_organization_id_idx" ON "invites"("email", "organization_id");
